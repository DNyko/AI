...
# Функція для обчислення ймовірностей переходу між містами
...
# Ініціалізація феромонів та матриці відстаней
...
# Кількість мурах та їхній список заборонених міст
num_agents = 25
tabu_list = [[] for _ in range(num_agents)]
# Ініціалізація змінних для зберігання найкращого маршруту
best_path_length = float('inf')
best_path = None

# Індекс міста для початку маршруту
start_city_index = 5  # варіант 6

# Поріг для зупинки алгоритму
some_threshold = 5600
k = 0;
...
for epoch in range(100):
    ...
    for ant in range(num_agents):
        ...
        # Побудова маршруту для кожної мурашки
    ...
    # Оновлення феромонів за кращі маршрути
    for ant in range(num_agents):
    ...
    # Виведення результатів на кожні 10 епох
    if epoch % 10 == 0:
        print(f"Епоха {epoch}, Довжина найкращого маршруту: {best_path_length}")

    # Перевірка умови зупинки
    if best_path_length < some_threshold:
        print(f"Зупинка: Досягнуто оптимальний результат на епоці {epoch}.")
        break  # Завершити цикл, якщо досягнуто оптимальний результат

# Візуалізація результатів
plt.figure(figsize=(10, 8))

# Виведення найкращого шляху
